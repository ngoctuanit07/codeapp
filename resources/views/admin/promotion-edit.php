...
$body = [
    'title' => 'Chỉnh sửa mốc khuyến mãi',
    'desc'   => 'CMSNT Panel',
...
if (isset($_GET['id'])) {
    ...
    if (!$row) {
        redirect(base_url('admin/promotion-list'));
    }
} else {
    redirect(base_url('admin/promotion-list'));
}
...
if (isset($_POST['SavePromotion'])) {
    ...
    $isInsert = $CMSNT->update("promotions", [
    ...
    if ($isInsert) {
        ...
        $CMSNT->insert("logs", [
            ...
            'createdate'    => gettime(),
            'action'        => "Chỉnh sửa mốc khuyến mãi (".format_currency($row['amount'])." ID ".$row['id'].")."
        ]);
        /** SEND NOTI CHO ADMIN */
        $my_text = '['.$getUser['username'].'] Cập nhật mốc khuyến mãi ('.format_currency($row['amount']).' ID '.$row['id'].').';
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Chỉnh sửa mốc khuyến mãi</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Chỉnh sửa mốc khuyến mãi</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="card-footer clearfix">
                                <button name="SavePromotion" class="btn btn-info btn-icon-left m-b-10" type="submit"><i
