...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Chỉnh sửa tiền tệ</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Chỉnh sửa tiền tệ</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form method="POST" action="" accept-charset="UTF-8">
                            <div class="card-body row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text" value="<?=$row['name'];?>" class="form-control" id="name" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="rate" type="text" class="form-control" id="rate"
                                            placeholder="Bao nhiêu VND cho 1 đơn vị tiền tệ này" value="<?=$row['rate'];?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="decimal_currency" type="number" class="form-control" id="decimal_currency"
                                            placeholder="VND là 0, USD là 2" value="<?=$row['decimal_currency'];?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="seperator">Seperator:</label>
                                        <select class="form-control" name="seperator" required>
                                            <option <?=$row['seperator'] == 'comma' ? 'selected' : '';?> value="comma">Comma (,)</option>
                                            <option <?=$row['seperator'] == 'space' ? 'selected' : '';?> value="space">Space ( )</option>
                                            <option <?=$row['seperator'] == 'dot' ? 'selected' : '';?> value="dot">Dot (.)</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" name="SaveCurrency" class="btn btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </section>
