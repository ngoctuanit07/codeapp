...
if (isset($_POST['AddDocument'])) {
    ...
    if ($CMSNT->get_row("SELECT * FROM `documents` WHERE `name` = '".check_string($_POST['name'])."' ")) {
        die('<script type="text/javascript">if(!alert("Tên tài liệu này đã tồn tại trong hệ thống.")){window.history.back().location.reload();}</script>');
    }
    $isInsert = $CMSNT->insert("documents", [
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="stt" value="0" placeholder="Nhập số thứ tự sắp xếp" required></input>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tiêu đề tài liệu</label>
                                    <input type="text" class="form-control" name="name" placeholder="Nhập tiêu đề tài liệu" required></input>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="price" placeholder="Nhập giá bán tài liệu này" required></input>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer clearfix">
                                <button name="AddDocument" class="btn btn-info btn-icon-left m-b-10" type="submit"><i
